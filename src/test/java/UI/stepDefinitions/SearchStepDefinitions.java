...
import UI.Base.BaseStepDefinition;
...
public class SearchStepDefinitions extends BaseStepDefinition {
    ...
    public void the_search_results_should_be_sorted_accordingly() throws InterruptedException {
        ...
        Assert.assertEquals(newsorted,Prices,"not sorted by high to low");
    }
